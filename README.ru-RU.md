...
Предполагается, что целевое устройство оснащено чувствительным к нажатию экраном, и управление приложением осуществляется нажатиями на экран.  
Может быть запущено несколько экземпляров приложения -- в разных окнах или на разных устройствах.  
